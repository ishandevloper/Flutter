...
class McqPage extends StatefulWidget {
  ...
  const McqPage({Key? key, required this.testId}) : super(key: key);
...
class _McqPageState extends State<McqPage> {
  ...
  Future<Duration> fetchTimeFromAPI() async {
    final response = await http.get(
        Uri.parse('https://theeracivilservice.com/api/exam/${widget.testId}'));
  ...
  Future<void> fetchQuestions() async {
    try {
      ...
      final response = await http.get(Uri.parse(
          'https://theeracivilservice.com/api/questions/${widget.testId}'));
      if (response.statusCode == 200) {
  ...
  void goToNextQuestion() async {
    if (selectedOptionIndex != null) {
      final selectedOptionText =
          questions[currentQuestionIndex]['choice$selectedOptionIndex'];
      final questionId = questions[currentQuestionIndex]['id'];
      final testId = widget.testId;
      final userId = 123; // Replace '123' with the actual user ID
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                  color: selectedOptionIndex == 1
                                      ? Colors.white
                                      : Colors.black,
                                  fontWeight: selectedOptionIndex == 1
                                      ? FontWeight.bold
                                      : FontWeight.normal,
                                ),
                              ),
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                  color: selectedOptionIndex == 2
                                      ? Colors.white
                                      : Colors.black,
                                  fontWeight: selectedOptionIndex == 2
                                      ? FontWeight.bold
                                      : FontWeight.normal,
                                ),
                              ),
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                  color: selectedOptionIndex == 3
                                      ? Colors.white
                                      : Colors.black,
                                  fontWeight: selectedOptionIndex == 3
                                      ? FontWeight.bold
                                      : FontWeight.normal,
                                ),
                              ),
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                  color: selectedOptionIndex == 4
                                      ? Colors.white
                                      : Colors.black,
                                  fontWeight: selectedOptionIndex == 4
                                      ? FontWeight.bold
                                      : FontWeight.normal,
                                ),
                              ),
