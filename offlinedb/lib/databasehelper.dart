// /*
// three plugin which is important for sqlflite you have to install it every time when you create a new project.
...
// created_at: the time that the item was created. It will be automatically 
//handled by SQLite
  // Create new item 
