...
insertNewData(String name, String contact, String housenumber) async{
   // var uri;
    var response = await http.post(
      Uri.parse("https://ishaanfirstflutterapi.000webhostapp.com/insert_data.php"),
      body: {"name": name,"contact": contact, "housenumber": housenumber}
    );
    print(response.body);
  }
